...
# Carregar música em loop infinito
pygame.mixer.music.load("musica_suspense.mp3")
...
while running:
    ...
    # Exibir as mensagens no canto superior esquerdo
    text_surface_1 = font.render(message_1, True, text_color)
    text_surface_2 = font.render(message_2, True, text_color)
    text_surface_3 = font.render(message_3, True, text_color)
    window.blit(text_surface_1, (10, 10))
    window.blit(text_surface_2, (10, 40))
    window.blit(text_surface_3, (10, 70))
